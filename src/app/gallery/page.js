...
export default function Gallery() {
  return (
    <main id="main">
      <section className="page-hero"><p className="eyebrow">Nail inspiration in Vernon</p><h1>Your next set starts here.</h1><p>Explore clean classics, joyful colour, chrome finishes and detailed custom art from our nail tables.</p></section>
      ...
      <section className="page-cta"><h2>See something you love?</h2><p>Save the look and bring it to your appointment.</p><a className="button" href={BOOKING_URL} target="_blank" rel="noreferrer">Book your set <span>↗</span></a></section>
    </main>
  );
}
