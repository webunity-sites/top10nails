    ...
    <main id="main">
      ...
      <section className="hero" id="top">
        <div className="hero-copy">
          ...
          <div className="hero-actions"><Link className="button" href="/contact#booking">Book your appointment <span>↗</span></Link><Link className="text-link" href="/services">Explore services <span>→</span></Link></div>
